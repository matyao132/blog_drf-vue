    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='作成部')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='machablog.category', verbose_name='カテゴリ')),
            ],
            options={
                'ordering': ('-created_at',),
            },
